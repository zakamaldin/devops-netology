...
- ДЗ к лекции 4
  - tflint
    ...
    - не указан версия провайдера
  - checkov
    - Не выдал результат, как будто не запустился
...
- Демо к лекции 4
  - tflint
    - Использование в модуле ветки `main` в качестве ветки по умолчанию
    - переменная объявлена, но не используется
    - не указан версия провайдера
  - checkov
...
### Ответ:
  Pull Request - https://github.com/zakamaldin/devops-netology/pull/25
------
### Задание 4
